...
const CommentsForm = ({ slug }) => {
    ...
    const handleCommentSubmission = () => {
        ...
        const { checked: storeData } = storaDataEl.current;
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
            ...
            <div className="grid grid-cols-1 gap-4 mb-4">
                <div className>
                    <input ref={storaDataEl} type="checkbox" id="storeData" name="storeData" value="true" />
                    <label className="text-gray-500 cursor-pointer ml-2" htmlFor="storeData">Save my e-mail and name for the next comment</label>
                </div>
            </div>
